...
main(int argc, char *argv[])
{
    ...
    for(int addy = 0; readAndParse(inFilePtr, label, opcode, arg0, arg1, arg2); ++addy ){
      ...
      //check for the opcode validity: if it doesnt equal any of them then theyll all be 1's
      if( (strcmp(opcode, "add") != 0) && (strcmp(opcode, "nor") != 0) && (strcmp(opcode, "lw") != 0) && (strcmp(opcode, "sw") != 0) && (strcmp(opcode, "beq") != 0) && (strcmp(opcode, "jalr") != 0) && (strcmp(opcode, "halt") != 0) && (strcmp(opcode, "noop") != 0) && (strcmp(opcode, ".fill") != 0) )  exit(1);
